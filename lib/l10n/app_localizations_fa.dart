...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get displayEffects => 'افکت‌های نمایشی';

  @override
  String get blurEnabled => 'پس‌زمینه محو (Blur)';
  ...
  @override
  String get noInternetConnection => 'اتصال اینترنت برقرار نیست. لطفاً اینترنت خود را چک کنید.';

  @override
  String get retry => 'تلاش مجدد';

  @override
  String get vpnDetected => 'وی‌پی‌ان روشن است';

  @override
  String get vpnWarningMessage => 'به نظر می‌رسد از فیلترشکن استفاده می‌کنید. لطفاً برای تجربه بهتر و سرعت بالاتر آن را خاموش کنید.';

  @override
  String get continueAnyway => 'ادامه دادن';

  @override
  String get weatherSource => 'منبع آب‌وهوا';
}
